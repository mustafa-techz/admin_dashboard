                ...
                students.map((student) => (
                  <div key={student.id} className="p-6 flex items-center justify-between hover:bg-muted/10 transition-colors group">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="font-black text-lg tracking-tight">{student.firstName} {student.lastName}</p>
                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">
                          Roll: {student.rollNumber} | Class {student.classId}{student.section}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button 
                        onClick={() => updateStudent({ id: student.id!, data: { firstName: student.firstName + " Updated" } })}
