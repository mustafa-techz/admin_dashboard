...
import { UpdateUserData, User, USER_ROLES } from '@/types/user';
...
interface EditUserModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (values: UpdateUserData) => Promise<void>;
  isLoading?: boolean;
}
...
export default function EditUserModal({ user, isOpen, onClose, onSubmit, isLoading }: EditUserModalProps) {
